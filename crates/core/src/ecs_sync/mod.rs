...
use simple_networking::Token;

use crate::serialization::{
    self, ComponentTypeAdapter, EventTypeAdapter,
...
pub enum SerializedChange {
    ...
    ComponentUpdated(NetId, NetTypeId, Option<serialization::BackingType>),
    EventEmitted(NetTypeId, serialization::BackingType),
}
