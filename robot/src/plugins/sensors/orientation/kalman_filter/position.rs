...
impl ROVObservationModel {
    pub fn new(config: &KalmanConfig) -> Self {
        ...
        observation[(meas_constants::ACC_X, state_constants::ACC_X)] = 0.0;
        observation[(meas_constants::ACC_Y, state_constants::ACC_Y)] = 0.0;
        observation[(meas_constants::ACC_Z, state_constants::ACC_Z)] = 0.0;

        observation[(meas_constants::ACC_X, state_constants::BIAS_ACC_X)] = 0.0;
        observation[(meas_constants::ACC_Y, state_constants::BIAS_ACC_Y)] = 0.0;
        observation[(meas_constants::ACC_Z, state_constants::BIAS_ACC_Z)] = 0.0;
        ...
        observation_noise[meas_constants::ACC_X] = 1e9;
        observation_noise[meas_constants::ACC_Y] = 1e9;
        observation_noise[meas_constants::ACC_Z] = 1e9;
