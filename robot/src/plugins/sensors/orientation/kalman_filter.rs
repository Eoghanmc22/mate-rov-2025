...
pub type KalmanFilter<'a> = KalmanFilterNoControl<'a, R, SS, OS>;
pub type KalmanState = StateAndCovariance<R, SS>;
pub type Observation = OVector<R, OS>;
...
pub fn create_initial_state() -> KalmanState {
...
pub fn observation_from_measurement(measurement: Measurement) -> Observation {
    OVector::<R, OS>::from_vec(vec![
        measurement.pos.x,
        measurement.pos.y,
        measurement.pos.z,
        measurement.accel.x,
...
//             create_initial_state, observation_from_measurement, KalmanConfig, Measurement,
//             ROVObservationModel, ROVTransitionModel, OS,
//         },
//         trajectory,
//     };
//
...
//             // Predict step
//             state = filter
//                 .step(&state, &observation_from_measurement(measurement))
//                 .unwrap();
